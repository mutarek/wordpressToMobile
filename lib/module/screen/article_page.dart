...
import 'package:wordpress_mobile/module/screen/details_page.dart';
...
class ArticlePage extends StatefulWidget {
  ...
  const ArticlePage(this.categoryId, {Key? key}) : super(key: key);
...
class _ArticlePageState extends State<ArticlePage> {
  ...
  Widget build(BuildContext context) {
    Provider.of<HomeProvider>(context, listen: false).getAllPosts(false, categoryCode: widget.categoryId);
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (builder) => DetailsScreen(data.content!.rendered, data.yoast_head_json!.ogImage[0].url)));
                              },
                              child: Stack(
                                children: [
                                  Container(
